...
export default function AppBar (props: any) {
    ...
    //     if(dimmer) dimmer.style.transform = `translateX(${trans})`;
    // }
    ...
    return (
        <Grid 
            ...
            style={{width: '98vw', position: 'relative', 
                ...
                <Grid 
                    ...
                    >
                        <Box display="flex" justifyContent="center" alignItems="center" mt={1}>
                            ...
                            <ButtonText active={activeTab === 2} handleClick={()=>activeTabIndicator(2)} className="app-tabs" label="Path Finding" id="pathF-v-btn" value="2" />
                        </Box>
